...
First, the `library()` function does not make a "library" but a "package" in your script. The function is called like that because it pulls a package *from a location on your computer called "library"*.
